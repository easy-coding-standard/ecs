...
use ECSPrefix202511\Nette\Utils\FileSystem;
...
final class ConfigInitializer
{
     ...
     */
    private $filesystem;
    public function __construct(FileProcessorCollector $fileProcessorCollector, SymfonyStyle $symfonyStyle, \Symplify\EasyCodingStandard\Configuration\InitPathsResolver $initPathsResolver, \ECSPrefix202511\Symfony\Component\Filesystem\Filesystem $filesystem)
    {
