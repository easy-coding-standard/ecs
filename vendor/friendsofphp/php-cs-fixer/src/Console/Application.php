...
use ECSPrefix202605\Symfony\Component\Console\Application as BaseApplication;
...
final class Application extends BaseApplication
{
    ...
    public static function getAbout(bool $decorated = \false) : string
    {
        ...
        // do not replace with imploded value, as here we need to prevent phar builder to replace the placeholder
        $versionCommit = $commitPlaceholder !== $commitPlaceholderPossiblyEvaluated ? \substr($commitPlaceholderPossiblyEvaluated, 0, 7) : '';
        $about = \implode('', [
            $longVersion,
    ...
    {
        return self::getAboutWithRuntime(\true);
    }
    ...
    protected function doRenderThrowable(\Throwable $e, OutputInterface $output) : void
    {
        ...
        if ($this->executedCommand instanceof WorkerCommand) {
            $output->writeln(WorkerCommand::ERROR_PREFIX . \json_encode(['class' => \get_class($e), 'message' => $e->getMessage(), 'file' => $e->getFile(), 'line' => $e->getLine(), 'code' => $e->getCode(), 'trace' => $e->getTraceAsString()], 0));
            return;
        }
