...
final class ReporterFactory
{
     ...
     */
    private $reporters = [];
    public function getReporter(string $format) : \PhpCsFixer\Console\Report\ListRulesReport\ReporterInterface
    {
    ...
    {
        $this->registerReporter(new \PhpCsFixer\Console\Report\ListRulesReport\JsonReporter())->registerReporter(new \PhpCsFixer\Console\Report\ListRulesReport\TextReporter());
        return $this;
    }
    /**
     * @return $this
     */
    public function registerReporter(\PhpCsFixer\Console\Report\ListRulesReport\ReporterInterface $reporter) : self
    {
