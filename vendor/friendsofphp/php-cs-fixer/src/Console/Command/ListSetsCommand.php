...
final class ListSetsCommand extends Command
{
    ...
    protected function configure() : void
    {
        ...
        \assert([] !== $formats);
        $this->setDefinition([new InputOption('format', '', InputOption::VALUE_REQUIRED, \PhpCsFixer\Console\Command\HelpCommand::getDescriptionWithAllowedValues('To output results in other formats (%s).', $formats), (new TextReporter())->getFormat(), $formats)]);
    }
