...
{
    private const POSSIBLE_KINDS = [\T_DOUBLE_COLON, \T_FUNCTION, CT::T_NAMESPACE_OPERATOR, \T_NEW, CT::T_RETURN_REF, \T_STRING, \T_OBJECT_OPERATOR, FCT::T_NULLSAFE_OBJECT_OPERATOR, FCT::T_ATTRIBUTE];
    /**
    ...
    {
        return $this->isGlobalFunctionCallOrUsage($tokens, $index, \true);
    }
