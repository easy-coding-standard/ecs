...
final class SymfonySet extends AbstractRuleSetDefinition
{
    public function getRules(): array
    {
        return [
            ...
            'braces_position' => ['allow_single_line_anonymous_functions' => \true, 'allow_single_line_empty_anonymous_classes' => \true],
            'class_attributes_separation' => ['elements' => ['method' => 'one']],
            'class_definition' => ['single_line' => \true],
            'class_reference_name_casing' => \true,
            'clean_namespace' => \true,
            'concat_space' => \true,
            // overrides @PER-CS2.0
            'declare_parentheses' => \true,
            'echo_tag_syntax' => \true,
            ...
            'include' => \true,
            'increment_style' => \true,
            'integer_literal_case' => \true,
            'lambda_not_used_import' => \true,
            'linebreak_after_opening_tag' => \true,
            'magic_constant_casing' => \true,
            ...
            'native_type_declaration_casing' => \true,
            'no_alias_language_construct_call' => \true,
            'no_alternative_syntax' => \true,
            'no_binary_string' => \true,
            ...
            'no_mixed_echo_print' => \true,
            'no_multiline_whitespace_around_double_arrow' => \true,
            'no_null_property_initialization' => \true,
            'no_short_bool_cast' => \true,
            'no_singleline_whitespace_before_semicolons' => \true,
            'no_spaces_around_offset' => \true,
            'no_superfluous_phpdoc_tags' => ['allow_hidden_params' => \true, 'remove_inheritdoc' => \true],
            'no_trailing_comma_in_singleline' => \true,
            'no_unneeded_braces' => ['namespaces' => \true],
            ...
            'no_unneeded_import_alias' => \true,
            'no_unset_cast' => \true,
            'no_unused_imports' => \true,
            'no_useless_concat_operator' => \true,
            'no_useless_else' => \true,
            'no_useless_nullsafe_operator' => \true,
            'no_useless_return' => \true,
            'no_whitespace_before_comma_in_array' => ['after_heredoc' => \true],
            'normalize_index_brace' => \true,
            'nullable_type_declaration_for_default_null_value' => \true,
            'object_operator_without_whitespace' => \true,
            'operator_linebreak' => ['only_booleans' => \true],
            'ordered_imports' => ['imports_order' => ['class', 'function', 'const'], 'sort_algorithm' => 'alpha'],
            'php_unit_fqcn_annotation' => \true,
            'php_unit_method_casing' => \true,
            'phpdoc_align' => \true,
            ...
            'phpdoc_var_annotation_correct_order' => \true,
            'phpdoc_var_without_name' => \true,
            'protected_to_private' => \true,
            'semicolon_after_instruction' => \true,
            'simple_to_complex_string_variable' => \true,
            'single_import_per_statement' => \true,
            'single_line_comment_spacing' => \true,
            'single_line_comment_style' => ['comment_types' => ['hash']],
            'single_line_empty_body' => \false,
            // overrides @PER-CS2.0
            'single_line_throw' => \true,
            'single_quote' => \true,
            'single_space_around_construct' => \true,
            'space_after_semicolon' => ['remove_in_empty_for_expressions' => \true],
            'standardize_increment' => \true,
            'standardize_not_equals' => \true,
            'statement_indentation' => ['stick_comment_to_next_continuous_control_statement' => \true],
            'switch_continue_to_break' => \true,
            'trailing_comma_in_multiline' => ['after_heredoc' => \true, 'elements' => [
                // explicitly omit 'arguments'
                'array_destructuring',
                'arrays',
                'match',
                'parameters',
