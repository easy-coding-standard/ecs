...
final class AutoRiskySet extends AbstractRuleSetDefinition implements AutomaticRuleSetDefinitionInterface
{
    ...
    {
        // order matters
        return [new \PhpCsFixer\RuleSet\Sets\PERCSRiskySet(), new \PhpCsFixer\RuleSet\Sets\AutoPHPMigrationRiskySet(), new \PhpCsFixer\RuleSet\Sets\AutoPHPUnitMigrationRiskySet()];
    }
