...
final class PHP7x0MigrationRiskySet extends AbstractMigrationSetDefinition
{
    ...
    {
        return ['@PHP5x6Migration:risky' => \true, 'combine_nested_dirname' => \true, 'declare_strict_types' => \true, 'non_printable_character' => \true, 'random_api_migration' => [
            // @TODO v4 replace with `true`
