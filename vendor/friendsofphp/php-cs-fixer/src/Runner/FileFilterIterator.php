...
final class FileFilterIterator extends \FilterIterator
{
     ...
     */
    public function __construct(iterable $iterator, ?EventDispatcherInterface $eventDispatcher, CacheManagerInterface $cacheManager)
    {
        if (!$iterator instanceof \Iterator) {
            $iterator = new \IteratorIterator($iterator instanceof \Traversable ? $iterator : new \ArrayIterator($iterator));
        }
