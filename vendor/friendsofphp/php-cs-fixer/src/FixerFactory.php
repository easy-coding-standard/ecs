...
use ECSPrefix202511\Symfony\Component\Finder\SplFileInfo;
/**
...
final class FixerFactory
{
    ...
    {
        return ['blank_lines_before_namespace' => ['no_blank_lines_before_namespace', 'single_blank_line_before_namespace'], 'no_blank_lines_before_namespace' => ['single_blank_line_before_namespace'], 'single_import_per_statement' => ['group_import']][$fixer->getName()] ?? [];
    }
    /**
