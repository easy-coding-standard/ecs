 ...
 *  types?: list<'boolean'|'callback'|'double'|'integer'|'never-return'|'never-returns'|'no-return'|'real'|'str'>,
 * }
...
final class PhpdocScalarFixer extends AbstractPhpdocTypesFixer implements ConfigurableFixerInterface
{
     ...
     * The types to fix.
     */
    private const TYPES_MAP = ['boolean' => 'bool', 'callback' => 'callable', 'double' => 'float', 'integer' => 'int', 'never-return' => 'never', 'never-returns' => 'never', 'no-return' => 'never', 'real' => 'float', 'str' => 'string'];
...
, ['types' => ['boolean']])]);
    ...
    protected function createConfigurationDefinition() : FixerConfigurationResolverInterface
    {
        ...
        return new FixerConfigurationResolver([(new FixerOptionBuilder('types', 'A list of types to fix.'))->setAllowedValues([new AllowedValueSubset($allowedTypes)])->setDefault(Future::getV4OrV3($allowedTypes, $defaultTypes))->getOption()]);
    }
    protected function normalize(string $type) : string
    {
        $suffix = '';
        while (\substr_compare($type, '[]', -\strlen('[]')) === 0) {
