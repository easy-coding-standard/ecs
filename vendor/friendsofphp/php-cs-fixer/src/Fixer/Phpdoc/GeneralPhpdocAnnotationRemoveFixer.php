...
, ['annotations' => ['package', 'subpackage']])]);
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('annotations', 'List of annotations to remove, e.g. `["author"]`.'))->setAllowedTypes(['string[]'])->setDefault([])->getOption(), (new FixerOptionBuilder('case_sensitive', 'Should annotations be case sensitive.'))->setAllowedTypes(['bool'])->setDefault(\true)->getOption()]);
    }
    /**
    ...
    private function getAnnotationsToRemove(DocBlock $doc) : array
    {
        ...
        $typesToSearchFor = \array_map(static function (string $type) : string {
