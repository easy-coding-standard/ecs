...
, ['case_sensitive' => \true])]);
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        foreach ($tokens as $index => $token) {
            ...
            foreach ($annotations as $annotation) {
                ...
                $line->setContent(Preg::replaceCallback('/\*\h*@method\h+' . TypeExpression::REGEX_TYPES . '\h+\K(?&callable)/', function (array $matches): string {
    ...
    private function sortTypes(TypeExpression $typeExpression): array
    {
        ...
        $sortedTypeExpression = $typeExpression->sortTypes(function (TypeExpression $a, TypeExpression $b) use ($normalizeType): int {
