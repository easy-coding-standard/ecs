...
final class PhpdocTypesFixer extends AbstractPhpdocTypesFixer implements ConfigurableFixerInterface
{
     ...
     */
    private const POSSIBLE_TYPES = ['alias' => ['boolean', 'double', 'integer'], 'meta' => ['$this', 'false', 'mixed', 'parent', 'resource', 'scalar', 'self', 'static', 'true', 'void'], 'simple' => ['array', 'bool', 'callable', 'float', 'int', 'iterable', 'null', 'object', 'string']];
    /** @var array<string, true> */
    private $typesSetToFix;
...
, ['groups' => ['simple', 'alias']])]);
    ...
    protected function configurePostNormalisation() : void
    {
        ...
        $this->typesSetToFix = \array_combine($typesToFix, \array_fill(0, \count($typesToFix), \true));
    }
    ...
    protected function createConfigurationDefinition() : FixerConfigurationResolverInterface
    {
        ...
        return new FixerConfigurationResolver([(new FixerOptionBuilder('groups', 'Type groups to fix.'))->setAllowedTypes(['string[]'])->setAllowedValues([new AllowedValueSubset($possibleGroups)])->setDefault($possibleGroups)->getOption()]);
    }
}
