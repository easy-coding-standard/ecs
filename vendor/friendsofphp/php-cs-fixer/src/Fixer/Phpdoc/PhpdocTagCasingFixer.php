...
final class PhpdocTagCasingFixer extends AbstractProxyFixer implements ConfigurableFixerInterface
{
    ...
    protected function configurePostNormalisation(): void
    {
        ...
        try {
            $generalPhpdocTagRenameFixer->configure(['case_sensitive' => \false, 'fix_annotation' => \true, 'fix_inline' => \true, 'replacements' => $replacements]);
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('tags', 'List of tags to fix with their expected casing.'))->setAllowedTypes(['string[]'])->setDefault(['inheritDoc'])->getOption()]);
    }
