...
EOF;
    ...
    protected function configurePostNormalisation() : void
    {
        ...
        $stringImplicitBackslashesFixer->configure(['single_quoted' => \true === $this->configuration['single_quoted'] ? 'escape' : 'ignore', 'double_quoted' => \true === $this->configuration['double_quoted'] ? 'escape' : 'ignore', 'heredoc' => \true === $this->configuration['heredoc_syntax'] ? 'escape' : 'ignore']);
    }
    protected function createProxyFixers() : array
    {
        $stringImplicitBackslashesFixer = new \PhpCsFixer\Fixer\StringNotation\StringImplicitBackslashesFixer();
        $stringImplicitBackslashesFixer->configure(['single_quoted' => 'ignore', 'double_quoted' => 'escape', 'heredoc' => 'escape']);
        return [$stringImplicitBackslashesFixer];
    }
