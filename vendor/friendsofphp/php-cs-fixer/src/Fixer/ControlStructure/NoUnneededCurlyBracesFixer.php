...
final class NoUnneededCurlyBracesFixer extends AbstractProxyFixer implements ConfigurableFixerInterface, DeprecatedFixerInterface
{
    ...
    /**
     * @var \PhpCsFixer\Fixer\ControlStructure\NoUnneededBracesFixer
     */
    private $noUnneededBracesFixer;
    public function __construct()
    {
        $this->noUnneededBracesFixer = new \PhpCsFixer\Fixer\ControlStructure\NoUnneededBracesFixer();
        parent::__construct();
    }
    public function getDefinition(): FixerDefinitionInterface
    {
        $fixerDefinition = $this->noUnneededBracesFixer->getDefinition();
        return new FixerDefinition('Removes unneeded curly braces that are superfluous and aren\'t part of a control structure\'s body.', $fixerDefinition->getCodeSamples(), $fixerDefinition->getDescription(), $fixerDefinition->getRiskyDescription());
    }
    /**
     * {@inheritdoc}
     *
    ...
    {
        return [$this->noUnneededBracesFixer->getName()];
    }
    /**
    ...
    {
        return [$this->noUnneededBracesFixer];
    }
}
