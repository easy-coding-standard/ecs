...
final class NoAlternativeSyntaxFixer extends AbstractFixer implements ConfigurableFixerInterface
{
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('fix_non_monolithic_code', 'Whether to also fix code with inline HTML.'))->setAllowedTypes(['bool'])->setDefault(Future::getV4OrV3(\false, \true))->getOption()]);
    }
    ...
    private function findParenthesisEnd(Tokens $tokens, int $structureTokenIndex): int
    {
        ...
        return $nextToken->equals('(') ? $tokens->findBlockEnd(Tokens::BLOCK_TYPE_PARENTHESIS_BRACE, $nextIndex) : $structureTokenIndex;
