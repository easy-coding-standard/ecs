...
final class PhpUnitInternalClassFixer extends AbstractPhpUnitFixer implements WhitespacesAwareFixerInterface, ConfigurableFixerInterface
{
    ...
    protected function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        ...
        return new FixerConfigurationResolver([(new FixerOptionBuilder('types', 'What types of classes to mark as internal.'))->setAllowedValues([new AllowedValueSubset($types)])->setAllowedTypes(['string[]'])->setDefault(['normal', 'final'])->getOption()]);
    }
    protected function applyPhpUnitClassFix(Tokens $tokens, int $startIndex, int $endIndex): void
    {
        ...
        if ($tokens[$prevIndex]->isGivenKind(\T_NEW)) {
            return;
            // Skip instantiation of anonymous classes
        }
        if (!$this->isAllowedByConfiguration($tokens, $classIndex)) {
            return;
        }
        $this->ensureIsDocBlockWithAnnotation($tokens, $classIndex, 'internal', ['internal'], []);
    }
