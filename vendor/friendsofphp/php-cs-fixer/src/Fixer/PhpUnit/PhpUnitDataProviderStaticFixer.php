...
class FooTest extends TestCase
{
    ...
    */
    ...
    public function provideSomethingCases1()
    {
        $this->getData1();
    }
    public function provideSomethingCases2()
    {
        self::getData2();
    }
}
...
class FooTest extends TestCase
{
    ...
    */
    ...
    public function provideSomething1Cases()
    {
        $this->getData1();
    }
    public function provideSomething2Cases()
    {
        self::getData2();
    }
}
...
, ['force' => \false])], null, 'Fixer could be risky if one is calling data provider function dynamically.');
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('force', 'Whether to make the data providers static even if they have a dynamic class call' . ' (may introduce fatal error "using $this when not in object context",' . ' and you may have to adjust the code manually by converting dynamic calls to static ones).'))->setAllowedTypes(['bool'])->setDefault(\false)->getOption()]);
    }
