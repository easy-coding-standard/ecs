...
SAMPLE
, ['after_heredoc' => \true])], 'This fixer covers rules defined in PSR2 ¶4.4, ¶4.6.');
    }
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        for ($index = 1; $index < $tokenCount; ++$index) {
            ...
            if ($isMultiline && \in_array($this->configuration['on_multiline'], ['ensure_fully_multiline', 'ensure_single_line_for_single_argument'], \true) && !$meaningfulTokenBeforeParenthesis->isGivenKind(\T_LIST)) {
    ...
    private function ensureFunctionFullyMultiline(Tokens $tokens, int $startFunctionIndex): void
    {
        ...
        do {
            $prevWhitespaceTokenIndex = $tokens->getPrevTokenOfKind($searchIndex, [[\T_ENCAPSED_AND_WHITESPACE], [\T_INLINE_HTML], [\T_WHITESPACE]]);
    ...
    private function fixSpace(Tokens $tokens, int $index): void
    {
        ...
        if ($nextToken->isWhitespace()) {
            ...
            if ((\false === $this->configuration['keep_multiple_spaces_after_comma'] || Preg::match('/\R/', $newContent)) && !$this->isCommentLastLineToken($tokens, $index + 2)) {
