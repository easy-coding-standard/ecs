...
final class AttributeEmptyParenthesesFixer extends AbstractFixer implements ConfigurableFixerInterface
{
    ...
    {
        return new FixerDefinition('PHP attributes declared without arguments must (not) be followed by empty parentheses.', [new CodeSample("<?php\n\n#[Foo()]\nclass Sample1 {}\n\n#[Bar(), Baz()]\nclass Sample2 {}\n"), new CodeSample("<?php\n\n#[Foo]\nclass Sample1 {}\n\n#[Bar, Baz]\nclass Sample2 {}\n", ['use_parentheses' => \true])]);
    }
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('use_parentheses', 'Whether attributes should be followed by parentheses or not.'))->setAllowedTypes(['bool'])->setDefault(\false)->getOption()]);
    }
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        while (null !== $index = $tokens->getNextTokenOfKind($index, [[\T_ATTRIBUTE]])) {
            ...
            do {
                ...
                if (\true === $this->configuration['use_parentheses']) {
