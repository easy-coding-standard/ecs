...
final class RandomApiMigrationFixer extends AbstractFunctionReferenceFixer implements ConfigurableFixerInterface
{
     ...
     */
    private const ARGUMENT_COUNTS = ['mt_getrandmax' => [0], 'getrandmax' => [0], 'mt_rand' => [1, 2], 'rand' => [0, 2], 'srand' => [0, 1], 'mt_srand' => [0, 1], 'random_int' => [0, 2]];
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        foreach ($this->configuration['replacements'] as $functionIdentity => $functionReplacement) {
            ...
            do {
                ...
                \assert(isset(self::ARGUMENT_COUNTS[$functionIdentity]));
                // for PHPStan
                if (!\in_array($count, self::ARGUMENT_COUNTS[$functionIdentity], \true)) {
                    continue 2;
                }
    ...
    protected function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('replacements', 'Mapping between replaced functions with the new ones.'))->setAllowedTypes(['array<string, string>'])->setAllowedValues([static function (array $value): bool {
            ...
            return \true;
        }])->setDefault(Future::getV4OrV3(['mt_getrandmax' => 'getrandmax', 'mt_rand' => 'random_int', 'mt_srand' => 'srand', 'rand' => 'random_int'], ['getrandmax' => 'mt_getrandmax', 'rand' => 'mt_rand', 'srand' => 'mt_srand']))->getOption()]);
    }
}
