...
final class CurlyBracesPositionFixer extends AbstractProxyFixer implements ConfigurableFixerInterface, DeprecatedFixerInterface, WhitespacesAwareFixerInterface
{
    ...
    /**
     * @var \PhpCsFixer\Fixer\Basic\BracesPositionFixer
     */
    ...
    public function getDefinition(): FixerDefinitionInterface
    {
        ...
        return new FixerDefinition('Curly braces must be placed as configured.', $fixerDefinition->getCodeSamples(), $fixerDefinition->getDescription(), $fixerDefinition->getRiskyDescription());
    }
    /**
     * {@inheritdoc}
     *
    ...
    {
        return [$this->bracesPositionFixer->getName()];
    }
    /**
