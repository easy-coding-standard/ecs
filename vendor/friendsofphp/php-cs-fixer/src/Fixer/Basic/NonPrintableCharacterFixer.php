...
final class NonPrintableCharacterFixer extends AbstractFixer implements ConfigurableFixerInterface
{
     ...
     */
    private const TOKENS = [\T_STRING_VARNAME, \T_INLINE_HTML, \T_VARIABLE, \T_COMMENT, \T_ENCAPSED_AND_WHITESPACE, \T_CONSTANT_ENCAPSED_STRING, \T_DOC_COMMENT];
    /**
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        foreach ($tokens as $index => $token) {
            ...
            if (\true === $this->configuration['use_escape_sequences_in_strings'] && $token->isGivenKind([\T_CONSTANT_ENCAPSED_STRING, \T_ENCAPSED_AND_WHITESPACE])) {
