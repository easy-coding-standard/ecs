...
final class BracesFixer extends AbstractProxyFixer implements ConfigurableFixerInterface, WhitespacesAwareFixerInterface, DeprecatedFixerInterface
{
    ...
    /**
     * @var \PhpCsFixer\Fixer\Basic\BracesPositionFixer|null
     */
    private $bracesPositionFixer;
    /**
     * @var \PhpCsFixer\Fixer\ControlStructure\ControlStructureContinuationPositionFixer|null
     */
...
, ['position_after_functions_and_oop_constructs' => self::LINE_SAME])]);
    ...
    protected function createProxyFixers() : array
    {
        ...
        $singleSpaceAroundConstructFixer->configure(['constructs_contain_a_single_space' => [], 'constructs_followed_by_a_single_space' => ['elseif', 'for', 'foreach', 'if', 'match', 'while', 'use_lambda'], 'constructs_preceded_by_a_single_space' => ['use_lambda']]);
        $noExtraBlankLinesFixer = new NoExtraBlankLinesFixer();
        $noExtraBlankLinesFixer->configure(['tokens' => ['curly_brace_block']]);
        return [$singleSpaceAroundConstructFixer, new ControlStructureBracesFixer(), $noExtraBlankLinesFixer, $this->getBracesPositionFixer(), $this->getControlStructureContinuationPositionFixer(), new DeclareParenthesesFixer(), new \PhpCsFixer\Fixer\Basic\NoMultipleStatementsPerLineFixer(), new StatementIndentationFixer(\true)];
    }
    private function getBracesPositionFixer() : \PhpCsFixer\Fixer\Basic\BracesPositionFixer
    {
        if (null === $this->bracesPositionFixer) {
            $this->bracesPositionFixer = new \PhpCsFixer\Fixer\Basic\BracesPositionFixer();
        }
    ...
    {
        return self::LINE_NEXT === $option ? \PhpCsFixer\Fixer\Basic\BracesPositionFixer::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END : \PhpCsFixer\Fixer\Basic\BracesPositionFixer::SAME_LINE;
    }
}
