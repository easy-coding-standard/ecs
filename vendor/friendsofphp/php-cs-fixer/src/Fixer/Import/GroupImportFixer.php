...
use ECSPrefix202511\A\Foo;
use function ECSPrefix202511\B\foo;
use ECSPrefix202511\A\Bar;
use function ECSPrefix202511\B\bar;
...
, ['group_types' => [self::GROUP_CLASSY]])]);
    ...
    {
        $newTokens = [new Token([\T_STRING, (string) \substr($useDeclaration->getFullName(), \strripos($useDeclaration->getFullName(), '\\') + 1)]), new Token([\T_WHITESPACE, ' ']), new Token([\T_AS, 'as']), new Token([\T_WHITESPACE, ' '])];
        $tokens->insertAt($insertIndex, $newTokens);
