...
final class VisibilityRequiredFixer extends AbstractProxyFixer implements ConfigurableFixerInterface, DeprecatedFixerInterface
{
    ...
    /**
     * @var \PhpCsFixer\Fixer\ClassNotation\ModifierKeywordsFixer
     */
    private $proxyFixer;
    public function __construct()
    {
        $this->proxyFixer = new \PhpCsFixer\Fixer\ClassNotation\ModifierKeywordsFixer();
        parent::__construct();
    }
    public function getDefinition(): FixerDefinitionInterface
    {
        $fixerDefinition = $this->proxyFixer->getDefinition();
        return new FixerDefinition($fixerDefinition->getSummary(), $fixerDefinition->getCodeSamples(), $fixerDefinition->getDescription(), $fixerDefinition->getRiskyDescription());
    }
