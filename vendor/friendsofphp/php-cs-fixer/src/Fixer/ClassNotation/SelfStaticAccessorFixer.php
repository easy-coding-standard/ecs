...
\class_alias('ECSPrefix202511\\Foo', 'Foo', \false);
...
, new VersionSpecification(80100))]);
    ...
    {
        return $tokens->isTokenKindFound(\T_STATIC) && $tokens->isAnyTokenKindsFound(self::CLASSY_TYPES) && $tokens->isAnyTokenKindsFound([\T_DOUBLE_COLON, \T_NEW, \T_INSTANCEOF]);
    }
    /**
     * {@inheritdoc}
     *
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens) : void
    {
        ...
        while (null !== $classyIndex) {
            if ($tokens[$classyIndex]->isGivenKind(\T_CLASS)) {
                ...
                if (isset($modifiers['final']) || $this->tokensAnalyzer->isAnonymousClass($classyIndex)) {
