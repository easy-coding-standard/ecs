...
final class NoExtraBlankLinesFixer extends AbstractFixer implements ConfigurableFixerInterface, WhitespacesAwareFixerInterface
{
     ...
     */
    private const AVAILABLE_TOKENS = ['attribute', 'break', 'case', 'comma', 'continue', 'curly_brace_block', 'default', 'extra', 'parenthesis_brace_block', 'return', 'square_brace_block', 'switch', 'throw', 'use', 'use_trait'];
    /**
...
use ECSPrefix202605\Bar\Baz;
use ECSPrefix202605\Baz\Bar;
class Bar
{
}
...
, ['tokens' => ['switch', 'case', 'default']])]);
    ...
    protected function configurePostNormalisation(): void
    {
        ...
        $this->tokenEqualsMap = [];
        if (\in_array('comma', $tokensConfiguration, \true)) {
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('tokens', 'List of tokens to fix.'))->setAllowedTypes(['string[]'])->setAllowedValues([new AllowedValueSubset(self::AVAILABLE_TOKENS)])->setDefault(['extra'])->getOption()]);
    }
    /**
     * @uses fixAfterToken()
