...
final class NativeFunctionTypeDeclarationCasingFixer extends AbstractProxyFixer implements DeprecatedFixerInterface
{
    ...
    {
        return new FixerDefinition('Native type declarations for functions should use the correct case.', [new CodeSample("<?php\nclass Bar {\n    public function Foo(CALLABLE \$bar)\n    {\n        return 1;\n    }\n}\n"), new CodeSample("<?php\nfunction Foo(INT \$a): Bool\n{\n    return true;\n}\n"), new CodeSample("<?php\nfunction Foo(Iterable \$a): VOID\n{\n    echo 'Hello world';\n}\n"), new CodeSample("<?php\nfunction Foo(Object \$a)\n{\n    return 'hi!';\n}\n")]);
    }
    ...
    {
        $fixer = new \PhpCsFixer\Fixer\Casing\NativeTypeDeclarationCasingFixer();
        return [$fixer];
    }
}
