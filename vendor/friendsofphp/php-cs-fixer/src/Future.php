...
final class Future
{
     ...
     * @var bool
     */
    private static $isFutureModeEnforced = \false;
    /**
    ...
    {
        return self::$isFutureModeEnforced || filter_var(getenv('PHP_CS_FIXER_FUTURE_MODE'), \FILTER_VALIDATE_BOOL);
    }
