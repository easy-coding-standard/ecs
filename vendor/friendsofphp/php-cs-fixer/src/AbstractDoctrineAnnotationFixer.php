...
abstract class AbstractDoctrineAnnotationFixer extends \PhpCsFixer\AbstractFixer implements ConfigurableFixerInterface
{
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('ignored_tags', 'List of tags that must not be treated as Doctrine Annotations.'))->setAllowedTypes(['string[]'])->setDefault([
            // PHPDocumentor 1
            'abstract',
            'access',
            'code',
