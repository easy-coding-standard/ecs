...
namespace ECSPrefix202605\React\EventLoop;

use BadMethodCallException;
use ECSPrefix202605\libev\EventLoop;
use ECSPrefix202605\libev\IOEvent;
use ECSPrefix202605\libev\SignalEvent;
use ECSPrefix202605\libev\TimerEvent;
use ECSPrefix202605\React\EventLoop\Tick\FutureTickQueue;
use ECSPrefix202605\React\EventLoop\Timer\Timer;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('ECSPrefix202605\libev\EventLoop', \false)) {
