...
namespace ECSPrefix202511\React\EventLoop;

use BadMethodCallException;
use ECSPrefix202511\libev\EventLoop;
use ECSPrefix202511\libev\IOEvent;
use ECSPrefix202511\libev\SignalEvent;
use ECSPrefix202511\libev\TimerEvent;
use ECSPrefix202511\React\EventLoop\Tick\FutureTickQueue;
use ECSPrefix202511\React\EventLoop\Timer\Timer;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('ECSPrefix202511\\libev\\EventLoop', \false)) {
