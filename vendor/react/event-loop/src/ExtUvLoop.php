...
final class ExtUvLoop implements LoopInterface
{
    ...
    {
        if (!\function_exists('uv_loop_new') && !\function_exists('ECSPrefix202605\uv_loop_new')) {
    ...
    {
        if (!isset($this->streamEvents[(int) $stream])) {
            $this->streamEvents[(int) $stream] = \ECSPrefix202605\uv_poll_init_socket($this->uv, $stream);
        }
