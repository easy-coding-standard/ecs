...
namespace ECSPrefix202605\React\ChildProcess;

use ECSPrefix202605\Evenement\EventEmitter;
use ECSPrefix202605\React\EventLoop\Loop;
use ECSPrefix202605\React\EventLoop\LoopInterface;
use ECSPrefix202605\React\Stream\ReadableResourceStream;
use ECSPrefix202605\React\Stream\ReadableStreamInterface;
use ECSPrefix202605\React\Stream\WritableResourceStream;
use ECSPrefix202605\React\Stream\WritableStreamInterface;
use ECSPrefix202605\React\Stream\DuplexResourceStream;
...
class Process extends EventEmitter
{
    ...
    final public static function isSigchildEnabled()
    {
        ...
        if (!\function_exists('phpinfo') && !\function_exists('ECSPrefix202605\phpinfo')) {
