...
use ECSPrefix202605\Symfony\Component\Console\Descriptor\ApplicationDescription;
...
class ListCommand extends Command
{
    ...
    protected function configure()
    {
        ...
        }), new InputOption('raw', null, InputOption::VALUE_NONE, 'To output raw command list'), new InputOption('format', null, InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt', static function () {
