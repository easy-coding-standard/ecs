 ...
 */
namespace ECSPrefix202605\Symfony\Component\Console\Descriptor;
...
class TextDescriptor extends Descriptor
{
    ...
    protected function describeApplication(Application $application, array $options = []): void
    {
        ...
        if (isset($options['raw_text']) && $options['raw_text']) {
            ...
            $width = $this->getColumnWidth(array_merge(...array_values(array_map(static function ($namespace) use ($commands) {
            ...
            foreach ($namespaces as $namespace) {
                $namespace['commands'] = array_filter($namespace['commands'], static function ($name) use ($commands) {
