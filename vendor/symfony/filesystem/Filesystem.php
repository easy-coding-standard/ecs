 ...
 */
namespace ECSPrefix202605\Symfony\Component\Filesystem;

use ECSPrefix202605\Symfony\Component\Filesystem\Exception\FileNotFoundException;
use ECSPrefix202605\Symfony\Component\Filesystem\Exception\InvalidArgumentException;
...
class Filesystem
{
    ...
    public function makePathRelative(string $endPath, string $startPath) : string
    {
        ...
        $splitDriveLetter = static function ($path) {
        ...
        try {
            ...
            if (\file_exists($tmpFile)) {
                if ('\\' === \DIRECTORY_SEPARATOR && !\is_writable($tmpFile)) {
                    self::box('chmod', $tmpFile, self::box('fileperms', $tmpFile));
                }
