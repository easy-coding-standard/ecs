...
use ECSPrefix202605\Symfony\Contracts\Service\Attribute\Required;
use ECSPrefix202605\Symfony\Contracts\Service\Attribute\SubscribedService;
/**
    ...
    public static function getSubscribedServices(): array
    {
        ...
        foreach ($reflectors as $reflector) {
            ...
            if ($reflector instanceof \ReflectionMethod) {
                ...
                if (!$autowireType = method_exists($reflector, 'getType') ? $reflector->getType() : null) {
            ...
            $attribute->key = $attribute->key ?? $defaultKey;
            $attribute->type = $attribute->type ?? $autowireType instanceof \ReflectionNamedType ? $autowireType->getName() : (string) $autowireType;
