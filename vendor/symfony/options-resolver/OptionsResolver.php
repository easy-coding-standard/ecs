 ...
 */
namespace ECSPrefix202605\Symfony\Component\OptionsResolver;

use ECSPrefix202605\Symfony\Component\OptionsResolver\Exception\AccessException;
use ECSPrefix202605\Symfony\Component\OptionsResolver\Exception\InvalidArgumentException;
use ECSPrefix202605\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException;
use ECSPrefix202605\Symfony\Component\OptionsResolver\Exception\MissingOptionsException;
use ECSPrefix202605\Symfony\Component\OptionsResolver\Exception\NoSuchOptionException;
use ECSPrefix202605\Symfony\Component\OptionsResolver\Exception\OptionDefinitionException;
use ECSPrefix202605\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
/**
...
class OptionsResolver implements Options
{
     ...
     */
    private $deprecatedNestedOptions = [];
    /**
     ...
     * @return $this
     */
    public function setOptions(string $option, \Closure $nested)
    {
        if ($this->locked) {
     ...
     * @return $this
     */
    public function setDeprecated(string $option, string $package, string $version, $message = 'The option "%name%" is deprecated.')
    {
        if ($this->locked) {
    ...
    public function offsetGet($option, bool $triggerDeprecation = \true)
    {
        ...
        if (isset($this->nested[$option])) {
            ...
            try {
                ...
                end($resolver->parentsOptions);
                if ($this->prototype && null !== $this->prototypeIndex && null !== $parentOptionKey = key($resolver->parentsOptions)) {
                    reset($resolver->parentsOptions);
     ...
     * @param mixed $value
     */
    private function verifyTypes(string $type, $value, ?array &$invalidTypes = null, int $level = 0): bool
    {
        $type = trim($type);
...
, $type);
     ...
     * @return $this
     */
    public function setIgnoreUndefined(bool $ignore = \true)
    {
