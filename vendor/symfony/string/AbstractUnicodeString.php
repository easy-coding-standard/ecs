 ...
 */
namespace ECSPrefix202511\Symfony\Component\String;

use ECSPrefix202511\Symfony\Component\String\Exception\ExceptionInterface;
use ECSPrefix202511\Symfony\Component\String\Exception\InvalidArgumentException;
use ECSPrefix202511\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    {
        $str = $this->camel();
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], 'ECSPrefix202511\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
    /**
     * @return static
