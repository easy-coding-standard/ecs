...
class DisallowSpaceIndentSniff implements Sniff
{
     ...
     */
    private const TOKENS_CONTAINING_INDENT = [\T_WHITESPACE => \true, \T_INLINE_HTML => \true, \T_DOC_COMMENT_WHITESPACE => \true, \T_COMMENT => \true, \T_END_HEREDOC => \true, \T_END_NOWDOC => \true];
    /**
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        for ($i = 0; $i < $phpcsFile->numTokens; $i++) {
            ...
            } elseif (isset($tokens[$i + 1]) === \true && $tokens[$i]['line'] < $tokens[$i + 1]['line']) {
            ...
            } else if ($foundTabs === $expectedTabs && $foundSpaces === $expectedSpaces) {
