...
class GitMergeConflictSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        $checkTokens = [\T_SL => \true, \T_SR => \true, \T_IS_IDENTICAL => \true, \T_COMMENT => \true, \T_DOC_COMMENT_STRING => \true, \T_ENCAPSED_AND_WHITESPACE => \true, \T_INLINE_HTML => \true, \T_HEREDOC => \true, \T_NOWDOC => \true];
