...
class CamelCapsFunctionNameSniff extends AbstractScopeSniff
{
     ...
     */
    protected const MAGIC_METHODS = ['construct' => \true, 'destruct' => \true, 'call' => \true, 'callstatic' => \true, 'get' => \true, 'set' => \true, 'isset' => \true, 'unset' => \true, 'sleep' => \true, 'wakeup' => \true, 'serialize' => \true, 'unserialize' => \true, 'tostring' => \true, 'invoke' => \true, 'set_state' => \true, 'clone' => \true, 'debuginfo' => \true];
    /**
     ...
     * @var array<string, true>
     */
    protected const DOUBLE_UNDERSCORE_METHODS = ['dorequest' => \true, 'getcookies' => \true, 'getfunctions' => \true, 'getlastrequest' => \true, 'getlastrequestheaders' => \true, 'getlastresponse' => \true, 'getlastresponseheaders' => \true, 'gettypes' => \true, 'setcookie' => \true, 'setlocation' => \true, 'setsoapheaders' => \true, 'soapcall' => \true];
    /**
     * A list of all PHP magic functions.
     *
     * @var array<string, true>
     */
    protected const MAGIC_FUNCTIONS = ['autoload' => \true];
    /**
    ...
    {
        parent::__construct(Tokens::OO_SCOPE_TOKENS, [\T_FUNCTION], \true);
    }
    /**
    ...
    protected function processTokenWithinScope(File $phpcsFile, int $stackPtr, int $currScope)
    {
        ...
        if (preg_match('|^__[^_]|', $methodName) !== 0) {
            ...
            if (isset(static::MAGIC_METHODS[$magicPart]) === \true || isset(static::DOUBLE_UNDERSCORE_METHODS[$magicPart]) === \true) {
                return;
            }
    ...
    protected function processTokenOutsideScope(File $phpcsFile, int $stackPtr)
    {
        ...
        if (preg_match('|^__[^_]|', $functionName) !== 0) {
            ...
            if (isset(static::MAGIC_FUNCTIONS[$magicPart]) === \true) {
                return;
            }
