...
class ForbiddenFunctionsSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        $ignore = [\T_DOUBLE_COLON => \true, \T_OBJECT_OPERATOR => \true, \T_NULLSAFE_OBJECT_OPERATOR => \true, \T_FUNCTION => \true, \T_CONST => \true, \T_PUBLIC => \true, \T_PRIVATE => \true, \T_PROTECTED => \true, \T_AS => \true, \T_NEW => \true, \T_INSTEADOF => \true, \T_IMPLEMENTS => \true];
        ...
        if (($tokens[$stackPtr]['code'] === \T_STRING || $tokens[$stackPtr]['code'] === \T_NAME_FULLY_QUALIFIED) && $tokens[$nextToken]['code'] !== \T_OPEN_PARENTHESIS) {
            // Not a call to a PHP function.
            return;
        }
        ...
        } else if (in_array($function, $this->forbiddenFunctionNames, \true) === \false) {
            return;
        }
