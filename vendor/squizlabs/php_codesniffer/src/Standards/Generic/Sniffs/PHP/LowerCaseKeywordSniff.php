...
class LowerCaseKeywordSniff implements Sniff
{
    ...
    public function register()
    {
        ...
        $targets += [\T_ANON_CLASS => \T_ANON_CLASS, \T_CLOSURE => \T_CLOSURE, \T_ENUM_CASE => \T_ENUM_CASE, \T_MATCH_DEFAULT => \T_MATCH_DEFAULT, \T_PARENT => \T_PARENT, \T_SELF => \T_SELF, \T_PUBLIC_SET => \T_PUBLIC_SET, \T_PROTECTED_SET => \T_PROTECTED_SET, \T_PRIVATE_SET => \T_PRIVATE_SET];
        return $targets;
    }
    /**
