...
class UnnecessaryStringConcatSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        if (isset(Tokens::STRING_TOKENS[$tokens[$prev]['code']]) === \false || isset(Tokens::STRING_TOKENS[$tokens[$next]['code']]) === \false) {
        ...
        if ($this->allowMultiline === \true && $tokens[$prev]['line'] !== $tokens[$next]['line']) {
            return;
        }
