...
class FunctionSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        $previousNonEmpty = $phpcsFile->findPrevious(Tokens::EMPTY_TOKENS, $stackPtr - 1, null, \true);
        ...
        if (isset(Tokens::EMPTY_TOKENS[$tokens[$next]['code']]) === \true && $tokens[$next]['line'] === $tokens[$closer]['line']) {
        ...
        */
        ...
        if ($prevLineToken === null) {
            ...
            if ($tokens[$firstBefore]['code'] === \T_COMMENT || isset(Tokens::PHPCS_ANNOTATION_TOKENS[$tokens[$firstBefore]['code']]) === \true) {
