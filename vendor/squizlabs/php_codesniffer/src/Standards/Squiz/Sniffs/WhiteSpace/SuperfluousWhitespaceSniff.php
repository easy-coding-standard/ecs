    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === \T_OPEN_TAG) {
            ...
            */
            ...
            if (isset($tokens[$stackPtr + 1]['line']) === \true && $tokens[$stackPtr + 1]['line'] === $tokens[$stackPtr]['line']) {
                return;
            }
            // Ignore blank lines if required.
            if ($this->ignoreBlankLines === \true && $tokens[$stackPtr]['code'] === \T_WHITESPACE && $tokens[$stackPtr - 1]['line'] !== $tokens[$stackPtr]['line']) {
                return;
            }
            ...
            } elseif ($tokens[$stackPtr - 1]['content'] !== rtrim($tokens[$stackPtr - 1]['content']) && $tokens[$stackPtr - 1]['line'] === $tokens[$stackPtr]['line']) {
            ...
            */
            if ($phpcsFile->hasCondition($stackPtr, [\T_FUNCTION, \T_CLOSURE]) === \true && $tokens[$stackPtr - 1]['line'] < $tokens[$stackPtr]['line'] && $tokens[$stackPtr - 2]['line'] === $tokens[$stackPtr - 1]['line']) {
                ...
                // line block.
                $next = $phpcsFile->findNext(\T_WHITESPACE, $stackPtr, null, \true);
