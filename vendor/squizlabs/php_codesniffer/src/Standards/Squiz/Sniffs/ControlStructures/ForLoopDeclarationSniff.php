...
class ForLoopDeclarationSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        if ($tokens[$prevNonWhiteSpace]['line'] !== $tokens[$closingBracket]['line'] && isset(Tokens::EMPTY_TOKENS[$tokens[$prevNonWhiteSpace]['code']]) === \true) {
        ...
        do {
            ...
            if ($semicolonCount !== 2 || $nextNonWhiteSpace !== $closingBracket) {
                ...
                } elseif ($tokens[$semicolon + 1]['code'] === \T_WHITESPACE && $tokens[$nextNonWhiteSpace]['code'] !== \T_SEMICOLON) {
