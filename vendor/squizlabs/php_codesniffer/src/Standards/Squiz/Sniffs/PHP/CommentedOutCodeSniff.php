...
class CommentedOutCodeSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        for ($i = $stackPtr; $i < $phpcsFile->numTokens; $i++) {
            ...
            if (isset(Tokens::PHPCS_ANNOTATION_TOKENS[$tokens[$i]['code']]) === \true) {
        ...
        */
        ...
        for ($i = 0; $i < $numTokens; $i++) {
            ...
            if (isset($emptyTokens[$stringTokens[$i]['code']]) === \false && isset(Tokens::COMPARISON_TOKENS[$stringTokens[$i]['code']]) === \false && isset(Tokens::ARITHMETIC_TOKENS[$stringTokens[$i]['code']]) === \false && $stringTokens[$i]['code'] !== \T_GOTO_LABEL) {
                // Looks like code.
                $numCode++;
            }
