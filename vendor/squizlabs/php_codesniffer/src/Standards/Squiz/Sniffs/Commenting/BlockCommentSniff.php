...
class BlockCommentSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === \T_DOC_COMMENT_OPEN_TAG) {
            ...
            $ignore += [\T_CLASS => \true, \T_INTERFACE => \true, \T_TRAIT => \true, \T_ENUM => \true, \T_FUNCTION => \true, \T_FINAL => \true, \T_STATIC => \true, \T_ABSTRACT => \true, \T_CONST => \true, \T_VAR => \true, \T_READONLY => \true];
        ...
        while (($nextComment = $phpcsFile->findNext(\T_WHITESPACE, $nextComment + 1, null, \true)) !== \false) {
            if ($tokens[$nextComment]['code'] !== $tokens[$stackPtr]['code'] && isset(Tokens::PHPCS_ANNOTATION_TOKENS[$tokens[$nextComment]['code']]) === \false) {
        ...
        if (count($commentLines) === 1) {
            ...
            $nextNonEmpty = $phpcsFile->findNext(Tokens::EMPTY_TOKENS, $stackPtr + 1, null, \true);
        ...
        } else if ($tokens[$stackPtr]['line'] - $tokens[$contentBefore]['line'] < 2) {
