...
class VariableCommentSniff extends AbstractVariableSniff
{
    ...
    public function processMemberVar(File $phpcsFile, int $stackPtr)
    {
        ...
        $ignore += [\T_VAR => \T_VAR, \T_STATIC => \T_STATIC, \T_READONLY => \T_READONLY, \T_FINAL => \T_FINAL, \T_ABSTRACT => \T_ABSTRACT, \T_WHITESPACE => \T_WHITESPACE, \T_NULLABLE => \T_NULLABLE, \T_TYPE_UNION => \T_TYPE_UNION, \T_TYPE_INTERSECTION => \T_TYPE_INTERSECTION, \T_TYPE_OPEN_PARENTHESIS => \T_TYPE_OPEN_PARENTHESIS, \T_TYPE_CLOSE_PARENTHESIS => \T_TYPE_CLOSE_PARENTHESIS, \T_NULL => \T_NULL, \T_TRUE => \T_TRUE, \T_FALSE => \T_FALSE, \T_SELF => \T_SELF, \T_PARENT => \T_PARENT];
