...
abstract class Generator
{
    ...
    public function __construct(Ruleset $ruleset)
    {
        ...
        $find = [\DIRECTORY_SEPARATOR . 'Sniffs' . \DIRECTORY_SEPARATOR, 'Sniff.php'];
        $replace = [\DIRECTORY_SEPARATOR . 'Docs' . \DIRECTORY_SEPARATOR, 'Standard.xml'];
    ...
    public function generate()
    {
        foreach ($this->docFiles as $file) {
            ...
            if ($documentation instanceof DOMNode === \false) {
                throw new GeneratorException('Missing top-level <documentation> element in XML documentation file ' . $file);
            }
