...
class LocalFile extends \PHP_CodeSniffer\Files\File
{
    ...
    public function process()
    {
        ...
        parent::process();
        $cache = ['hash' => $hash, 'errors' => $this->errors, 'warnings' => $this->warnings, 'metrics' => $this->metrics, 'errorCount' => $this->errorCount, 'warningCount' => $this->warningCount, 'fixableErrorCount' => $this->fixableErrorCount, 'fixableWarningCount' => $this->fixableWarningCount, 'numTokens' => $this->numTokens];
