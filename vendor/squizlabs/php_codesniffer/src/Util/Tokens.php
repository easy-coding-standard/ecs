...
final class Tokens
{
     ...
     */
    public const ASSIGNMENT_TOKENS = [\T_EQUAL => \T_EQUAL, \T_AND_EQUAL => \T_AND_EQUAL, \T_OR_EQUAL => \T_OR_EQUAL, \T_CONCAT_EQUAL => \T_CONCAT_EQUAL, \T_DIV_EQUAL => \T_DIV_EQUAL, \T_MINUS_EQUAL => \T_MINUS_EQUAL, \T_POW_EQUAL => \T_POW_EQUAL, \T_MOD_EQUAL => \T_MOD_EQUAL, \T_MUL_EQUAL => \T_MUL_EQUAL, \T_PLUS_EQUAL => \T_PLUS_EQUAL, \T_XOR_EQUAL => \T_XOR_EQUAL, \T_DOUBLE_ARROW => \T_DOUBLE_ARROW, \T_SL_EQUAL => \T_SL_EQUAL, \T_SR_EQUAL => \T_SR_EQUAL, \T_COALESCE_EQUAL => \T_COALESCE_EQUAL];
    /**
     * Tokens that represent equality comparisons.
     *
     * @var array<int|string, int|string>
     */
    public const EQUALITY_TOKENS = [\T_IS_EQUAL => \T_IS_EQUAL, \T_IS_NOT_EQUAL => \T_IS_NOT_EQUAL, \T_IS_IDENTICAL => \T_IS_IDENTICAL, \T_IS_NOT_IDENTICAL => \T_IS_NOT_IDENTICAL, \T_IS_SMALLER_OR_EQUAL => \T_IS_SMALLER_OR_EQUAL, \T_IS_GREATER_OR_EQUAL => \T_IS_GREATER_OR_EQUAL];
    /**
     * Tokens that represent comparison operator.
     *
     * @var array<int|string, int|string>
     */
    public const COMPARISON_TOKENS = self::EQUALITY_TOKENS + [\T_LESS_THAN => \T_LESS_THAN, \T_GREATER_THAN => \T_GREATER_THAN, \T_SPACESHIP => \T_SPACESHIP, \T_COALESCE => \T_COALESCE];
    /**
     * Tokens that represent arithmetic operators.
     *
     * @var array<int|string, int|string>
     */
    public const ARITHMETIC_TOKENS = [\T_PLUS => \T_PLUS, \T_MINUS => \T_MINUS, \T_MULTIPLY => \T_MULTIPLY, \T_DIVIDE => \T_DIVIDE, \T_MODULUS => \T_MODULUS, \T_POW => \T_POW];
    /**
     * Tokens that perform operations.
     *
     * @var array<int|string, int|string>
     */
    public const OPERATORS = self::ARITHMETIC_TOKENS + [\T_SPACESHIP => \T_SPACESHIP, \T_COALESCE => \T_COALESCE, \T_BITWISE_AND => \T_BITWISE_AND, \T_BITWISE_OR => \T_BITWISE_OR, \T_BITWISE_XOR => \T_BITWISE_XOR, \T_SL => \T_SL, \T_SR => \T_SR];
    /**
     * Tokens that perform boolean operations.
     *
     * @var array<int|string, int|string>
     */
    public const BOOLEAN_OPERATORS = [\T_BOOLEAN_AND => \T_BOOLEAN_AND, \T_BOOLEAN_OR => \T_BOOLEAN_OR, \T_LOGICAL_AND => \T_LOGICAL_AND, \T_LOGICAL_OR => \T_LOGICAL_OR, \T_LOGICAL_XOR => \T_LOGICAL_XOR];
    /**
     * Tokens that represent casting.
     *
     * @var array<int|string, int|string>
     */
    public const CAST_TOKENS = [\T_INT_CAST => \T_INT_CAST, \T_STRING_CAST => \T_STRING_CAST, \T_DOUBLE_CAST => \T_DOUBLE_CAST, \T_ARRAY_CAST => \T_ARRAY_CAST, \T_BOOL_CAST => \T_BOOL_CAST, \T_OBJECT_CAST => \T_OBJECT_CAST, \T_UNSET_CAST => \T_UNSET_CAST, \T_BINARY_CAST => \T_BINARY_CAST];
    /**
     * Token types that open parenthesis.
     *
     * @var array<int|string, int|string>
     */
    public const PARENTHESIS_OPENERS = [\T_ARRAY => \T_ARRAY, \T_LIST => \T_LIST, \T_FUNCTION => \T_FUNCTION, \T_CLOSURE => \T_CLOSURE, \T_USE => \T_USE, \T_ANON_CLASS => \T_ANON_CLASS, \T_WHILE => \T_WHILE, \T_FOR => \T_FOR, \T_FOREACH => \T_FOREACH, \T_SWITCH => \T_SWITCH, \T_IF => \T_IF, \T_ELSEIF => \T_ELSEIF, \T_CATCH => \T_CATCH, \T_DECLARE => \T_DECLARE, \T_MATCH => \T_MATCH, \T_ISSET => \T_ISSET, \T_EMPTY => \T_EMPTY, \T_UNSET => \T_UNSET, \T_EVAL => \T_EVAL, \T_EXIT => \T_EXIT];
    /**
     * Tokens that are allowed to open scopes.
     *
     * @var array<int|string, int|string>
     */
    public const SCOPE_OPENERS = [\T_CLASS => \T_CLASS, \T_ANON_CLASS => \T_ANON_CLASS, \T_INTERFACE => \T_INTERFACE, \T_TRAIT => \T_TRAIT, \T_ENUM => \T_ENUM, \T_NAMESPACE => \T_NAMESPACE, \T_FUNCTION => \T_FUNCTION, \T_CLOSURE => \T_CLOSURE, \T_IF => \T_IF, \T_SWITCH => \T_SWITCH, \T_CASE => \T_CASE, \T_DECLARE => \T_DECLARE, \T_DEFAULT => \T_DEFAULT, \T_WHILE => \T_WHILE, \T_ELSE => \T_ELSE, \T_ELSEIF => \T_ELSEIF, \T_FOR => \T_FOR, \T_FOREACH => \T_FOREACH, \T_DO => \T_DO, \T_TRY => \T_TRY, \T_CATCH => \T_CATCH, \T_FINALLY => \T_FINALLY, \T_USE => \T_USE, \T_MATCH => \T_MATCH];
    /**
     * Tokens that represent scope modifiers.
     *
     * @var array<int|string, int|string>
     */
    public const SCOPE_MODIFIERS = [\T_PRIVATE => \T_PRIVATE, \T_PUBLIC => \T_PUBLIC, \T_PROTECTED => \T_PROTECTED, \T_PUBLIC_SET => \T_PUBLIC_SET, \T_PROTECTED_SET => \T_PROTECTED_SET, \T_PRIVATE_SET => \T_PRIVATE_SET];
    /**
     * Tokens that can prefix a method name
     *
     * @var array<int|string, int|string>
     */
    public const METHOD_MODIFIERS = [\T_PRIVATE => \T_PRIVATE, \T_PUBLIC => \T_PUBLIC, \T_PROTECTED => \T_PROTECTED, \T_ABSTRACT => \T_ABSTRACT, \T_STATIC => \T_STATIC, \T_FINAL => \T_FINAL];
    /**
     * Tokens that open code blocks.
     *
     * @var array<int|string, int|string>
     */
    public const BLOCK_OPENERS = [\T_OPEN_CURLY_BRACKET => \T_OPEN_CURLY_BRACKET, \T_OPEN_SQUARE_BRACKET => \T_OPEN_SQUARE_BRACKET, \T_OPEN_PARENTHESIS => \T_OPEN_PARENTHESIS];
    /**
     * Tokens that represent brackets and parenthesis.
     *
     * @var array<int|string, int|string>
     */
    public const BRACKET_TOKENS = self::BLOCK_OPENERS + [\T_CLOSE_CURLY_BRACKET => \T_CLOSE_CURLY_BRACKET, \T_CLOSE_SQUARE_BRACKET => \T_CLOSE_SQUARE_BRACKET, \T_CLOSE_PARENTHESIS => \T_CLOSE_PARENTHESIS];
    /**
     ...
     * @var array<int|string, int|string>
     */
    public const COMMENT_TOKENS = self::PHPCS_ANNOTATION_TOKENS + [\T_COMMENT => \T_COMMENT, \T_DOC_COMMENT => \T_DOC_COMMENT, \T_DOC_COMMENT_STAR => \T_DOC_COMMENT_STAR, \T_DOC_COMMENT_WHITESPACE => \T_DOC_COMMENT_WHITESPACE, \T_DOC_COMMENT_TAG => \T_DOC_COMMENT_TAG, \T_DOC_COMMENT_OPEN_TAG => \T_DOC_COMMENT_OPEN_TAG, \T_DOC_COMMENT_CLOSE_TAG => \T_DOC_COMMENT_CLOSE_TAG, \T_DOC_COMMENT_STRING => \T_DOC_COMMENT_STRING];
    /**
     * Tokens that are comments containing PHPCS instructions.
     *
     * @var array<int|string, int|string>
     */
    public const PHPCS_ANNOTATION_TOKENS = [\T_PHPCS_ENABLE => \T_PHPCS_ENABLE, \T_PHPCS_DISABLE => \T_PHPCS_DISABLE, \T_PHPCS_SET => \T_PHPCS_SET, \T_PHPCS_IGNORE => \T_PHPCS_IGNORE, \T_PHPCS_IGNORE_FILE => \T_PHPCS_IGNORE_FILE];
    /**
     ...
     * @var array<int|string, int|string>
     */
    public const STRING_TOKENS = [\T_CONSTANT_ENCAPSED_STRING => \T_CONSTANT_ENCAPSED_STRING, \T_DOUBLE_QUOTED_STRING => \T_DOUBLE_QUOTED_STRING];
    /**
     * Tokens that represent text strings.
     *
     * @var array<int|string, int|string>
     */
    public const TEXT_STRING_TOKENS = self::STRING_TOKENS + [\T_INLINE_HTML => \T_INLINE_HTML, \T_HEREDOC => \T_HEREDOC, \T_NOWDOC => \T_NOWDOC];
    /**
     * Tokens that make up a heredoc string.
     *
     * @var array<int|string, int|string>
     */
    public const HEREDOC_TOKENS = [\T_START_HEREDOC => \T_START_HEREDOC, \T_END_HEREDOC => \T_END_HEREDOC, \T_HEREDOC => \T_HEREDOC, \T_START_NOWDOC => \T_START_NOWDOC, \T_END_NOWDOC => \T_END_NOWDOC, \T_NOWDOC => \T_NOWDOC];
    /**
     * Tokens that include files.
     *
     * @var array<int|string, int|string>
     */
    public const INCLUDE_TOKENS = [\T_REQUIRE_ONCE => \T_REQUIRE_ONCE, \T_REQUIRE => \T_REQUIRE, \T_INCLUDE_ONCE => \T_INCLUDE_ONCE, \T_INCLUDE => \T_INCLUDE];
    /**
     * Tokens used for "names", be it namespace, OO, function or constant names.
     *
     * @var array<int|string, int|string>
     */
    public const NAME_TOKENS = [\T_STRING => \T_STRING, \T_NAME_QUALIFIED => \T_NAME_QUALIFIED, \T_NAME_FULLY_QUALIFIED => \T_NAME_FULLY_QUALIFIED, \T_NAME_RELATIVE => \T_NAME_RELATIVE];
    /**
     ...
     * @var array<int|string, int|string>
     */
    public const FUNCTION_NAME_TOKENS = self::INCLUDE_TOKENS + self::NAME_TOKENS + [\T_EVAL => \T_EVAL, \T_EXIT => \T_EXIT, \T_ISSET => \T_ISSET, \T_UNSET => \T_UNSET, \T_EMPTY => \T_EMPTY, \T_SELF => \T_SELF, \T_PARENT => \T_PARENT, \T_STATIC => \T_STATIC, \T_ANON_CLASS => \T_ANON_CLASS];
    /**
     * Tokens that open class and object scopes.
     *
     * @var array<int|string, int|string>
     */
    public const OO_SCOPE_TOKENS = [\T_CLASS => \T_CLASS, \T_ANON_CLASS => \T_ANON_CLASS, \T_INTERFACE => \T_INTERFACE, \T_TRAIT => \T_TRAIT, \T_ENUM => \T_ENUM];
    /**
     ...
     */
    public const MAGIC_CONSTANTS = [\T_CLASS_C => \T_CLASS_C, \T_DIR => \T_DIR, \T_FILE => \T_FILE, \T_FUNC_C => \T_FUNC_C, \T_LINE => \T_LINE, \T_METHOD_C => \T_METHOD_C, \T_NS_C => \T_NS_C, \T_TRAIT_C => \T_TRAIT_C];
    /**
